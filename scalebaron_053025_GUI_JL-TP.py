...
# THIS VERSION CLONED from Josh's most recent upload, with user-friendly GUI layout changes from TP
...
class CompositeApp:
    def __init__(self, master):
        self.master = master
        master.title("ScaleBarOn v0.8.7")
        ...
        style = ttk.Style()
        style.configure("Hint.TLabel", foreground="gray", font=("TkDefaultFont", 9, "italic"))
        self.setup_widgets()
